...
const languages = {
  ...
  et: {
    ...
    label: 'Eesti Keel',
    code: 'EST',
    icon: 'https://cdn.parcellab.com/img/flags/et.png',
  },
  lt: {
    name: 'lt',
    label: 'Lietuvis',
    code: 'LTU',
    icon: 'https://cdn.parcellab.com/img/flags/lt.png',
  },
  lv: {
    name: 'lv',
    label: 'Latviski',
    code: 'LTV',
    icon: 'https://cdn.parcellab.com/img/flags/lv.png',
  }
}
...
const translations = {
  ...
  et: {
    ...
    more: 'Kuva rohkem ...',
    moreArticles: 'Kuva rohkem ...',
    orderNo: 'Tellimus',
    predictions: {
      OutForDelivery: 'Pakk saabub <b>täna</b>.',
      DestinationDeliveryCenter: 'Pakk saabub <b>homme</b>.'
    },
    openingHours: 'Lahtiolekuajad',
    weekDays: ['Pühapäev', 'Esmaspäev', 'Teisipäev', 'Kolmapäev', 'Neljapäev', 'Reede', 'Laupäev'],
    alwaysOpened: 'Ööpäevaringselt avatud',
    closesIn: 'Suletakse umbes',
    opensIn: 'Avatakse umbes',
    ...
    zip: 'Sihtnumber',
    enterZipCode: 'Kogu teabele juurdepääsuks sisestage oma sihtnumber.',
    wrongZip: 'Sihtnumber on vale.',
    search: 'Otsing',
    containsOf: 'hõlmab',
    deliveries: 'kohaletoimetamised',
    showPickuplocation: 'Kuva kättesaamise koht',
    liveDelivery: 'Reaalajas jälgimine',
    articleList: 'Selles pakis olevad esemed',
    deliveryAddress: 'Kohaletoimetamisaadress',
    liveTrackingLastUpdate: 'Viimane värskendus',
    liveTrackingStationsNext: 'Juht on teie poole teel.',
    liveTrackingStation: '{{openStops}} peatuskoht',
    liveTrackingStations: '{{openStops}} peatuskohta',
    liveTrackingCaption: 'teie saadetise saabumiseni.',
    liveTrackingCaptionNext: 'Teie olete järgmine peatuskoht.',
    liveTrackingPrediction: 'Saabumisaeg umbes',
    countryName: {
      AFG: 'Afganistan',
      ALB: 'Albaania',
      DZA: 'Alžeeria',
  ...
  lt: {
    ...
    more: 'Rodyti daugiau...',
    moreArticles: 'Rodyti daugiau...',
    orderNo: 'Užsakymas',
    predictions: {
      OutForDelivery: 'Paketas atkeliaus <b>šiandien</b>.',
      DestinationDeliveryCenter: 'Paketas atkeliaus <b>rytoj</b>.'
    },
    openingHours: 'Darbo valandos',
    weekDays: 'Sekmadienis, pirmadienis, antradienis, trečiadienis, ketvirtadienis, penktadienis, šeštadienis',
    alwaysOpened: 'Dirba 24 val.',
    closesIn: 'Uždaroma maždaug po',
    opensIn: 'Atidaroma maždaug po',
    ...
    zip: 'ZIP kodas',
    enterZipCode: 'Įveskite ZIP kodą, kad gautumėte prieigą prie visos informacijos.',
    wrongZip: 'Šis ZIP kodas neteisingas.',
    search: 'Ieškoti',
    containsOf: 'sudaro',
    deliveries: 'pristatymai',
    showPickuplocation: 'Rodyti paėmimo vietą',
    liveDelivery: 'Tiesioginis sekimas',
    articleList: 'Elementai šiame pakete',
    deliveryAddress: 'Pristatymo adresas',
    liveTrackingLastUpdate: 'Paskutinį kartą atnaujinta',
    liveTrackingStationsNext: 'Vairuotojas yra pakeliui pas jus.',
    liveTrackingStation: '{{openStops}} sustojimas',
    liveTrackingStations: '{{openStops}} sustojimai',
    liveTrackingCaption: 'kol jūsų siunta bus pristatyta.',
    liveTrackingCaptionNext: 'Kitas sustojimas – pas jus.',
    liveTrackingPrediction: 'Apytikslis atvykimo laikas.',
    countryName: {
      AFG: 'Afganistanas',
      ALB: 'Albanija',
      DZA: 'Alžyras',
      ...
      VGB: 'Mergelių Salos (Didžioji Britanija)',
      BRN: 'Brunėjus',
      BGR: 'Bulgarija',
      BFA: 'Burkina Fasas',
      BDI: 'Burundis',
      ...
      CYP: 'Kipras',
      CZE: 'Čekija',
      COD: 'Kongo Demokratinė Respublika',
      DNK: 'Danija',
      DJI: 'Džibutis',
      DMA: 'Dominika',
      ...
      FLK: 'Folklando Salos',
      FRO: 'Farerų Salos',
      FSM: 'Mikronezijos Federacinės Valstijos',
      FJI: 'Fidžis',
      FIN: 'Suomija',
      FRA: 'Prancūzija',
      GAB: 'Gabonas',
      ...
      PRT: 'Portugalija',
      QAT: 'Kataras',
      COG: 'Kongo Respublika',
      ROU: 'Rumunija',
      RUS: 'Rusija',
      RWA: 'Ruanda',
      SHN: 'Šv. Elenos, Dangun Žengimo ir Tristano da Kunjos salos',
      KNA: 'Sent Kitsas ir Nevis',
      LCA: 'Sent Lusija',
      VCT: 'Sent Vinsentas ir Grenadinai',
      SMR: 'San Marinas',
      SAU: 'Saudo Arabija',
      SEN: 'Senegalas',
      SRB: 'Serbija',
      ...
      SLE: 'Siera Leonė',
      SGP: 'Singapūras',
      SXM: 'Sint Martenas (Nyderlandai)',
      SVK: 'Slovakija',
      SVN: 'Slovėnija',
      SLB: 'Saliamono Salos',
      SOM: 'Somalis',
      ZAF: 'Pietų Afrika',
      SGS: 'Pietų Džordžijos ir Pietų Sandvičo Salos',
      KOR: 'Pietų Korėja',
      SSD: 'Pietų Sudanas',
      ESP: 'Ispanija',
      LKA: 'Šri Lanka',
  ...
  lv: {
    ...
    delivery: 'Piegāde',
    more: 'Rādīt vairāk...',
    moreArticles: 'Rādīt vairāk...',
    orderNo: 'Sakārtot',
    predictions: {
      OutForDelivery: 'Paciņa tiks piegādāta <b>šodien</b>.',
      DestinationDeliveryCenter: 'Paciņa tiks piegādāta <b>rīt</b>.'
    },
    openingHours: 'Darba laiks',
    weekDays: 'Svētdiena, pirmdiena, otrdiena, trešdiena, ceturtdiena, piektdiena, sestdiena',
    alwaysOpened: 'Atvērts 24 stundas',
    closesIn: 'Aizveras pēc aptuveni',
    opensIn: 'Atveras pēc aptuveni',
    ...
    zip: 'Pasta indekss',
    enterZipCode: 'Lūdzu, ievadiet savu pasta indeksu, lai iegūtu piekļuvi visai informācijai.',
    wrongZip: 'Šis pasta indekss ir nepareizs.',
    search: 'Meklēt',
    containsOf: 'sastāv no',
    deliveries: 'piegādes',
    showPickuplocation: 'Parādīt preču saņemšanas vietu',
    liveDelivery: 'Tiešraides izsekošana',
    articleList: 'Vienības šajā iepakojumā',
    deliveryAddress: 'Piegādes adrese',
    liveTrackingLastUpdate: 'Pēdējais atjauninājums',
    liveTrackingStationsNext: 'Autovadītājs ir ceļā pie jums.',
    liveTrackingStation: '{{openStops}} pieturvieta',
    liveTrackingStations: '{{openStops}} pieturvietas',
    liveTrackingCaption: 'līdz sūtījuma saņemšanai.',
    liveTrackingCaptionNext: 'Jūs esat nākamā pieturvieta.',
    liveTrackingPrediction: 'Ierašanās laiks apm.',
    countryName: {
      AFG: 'Afganistāna',
      ALB: 'Albānija',
      DZA: 'Alžīrija',
      ...
      BWA: 'Botsvāna',
      BRA: 'Brazīlija',
      IOT: 'Britu Indijas okeāna teritorija',
      ...
      FLK: 'Folklenda salas',
      FRO: 'Fēru salas',
      FSM: 'Mikronēzijas Federatīvās Valstis',
      FJI: 'Fidži',
      FIN: 'Somija',
      FRA: 'Francija',
      GAB: 'Gabona',
      ...
      RUS: 'Krievija',
      RWA: 'Ruanda',
      SHN: 'Svētās Helēnas, Debesbraukšanas un Tristana da Kuņas salas',
